...
void HFSPEInfo() {
  ...
  outfile11<<runno<<"_SPENtuples.root";
  TFile *f6 = new TFile(outfile11.str().c_str(),"RECREATE");
  outfile11.str("");
  
  TTree *tree1 = new TTree("HFSPEInfo","HSPEInfo");

  ifstream in;
  stringstream hfspeinfo;
  hfspeinfo<<runno<<"_HFSPE650Info.txt";
  in.open(hfspeinfo.str().c_str(),ios::in);
  if(!(in.good())) {cout<<"There is no hfspeinfo.txt"<<endl;}
  hfspeinfo.str("");

  ifstream in1;
  stringstream hfspeinfo1;
  hfspeinfo1<<runno<<"_HFSPE700Info.txt";
  in1.open(hfspeinfo1.str().c_str(),ios::in);
  if(!(in1.good())) {cout<<"There is no hfspeinfo.txt"<<endl;}
  hfspeinfo1.str("");
  ...
  while(in>>LEDMEAN650>>PEDMEAN650>>LEDRMS650>>PEDRMS650>>TRUEMEAN650>>TRUERMS650>>NPE650>>Charge650>>GAIN650>>Rel_TRUEMEAN650>>Rel_NPE650>>Rel_Charge650>>Rel_GAIN650>>qie650>>ieta650>>depth650>>calib650) {
    ...
    tree1->Branch("B904SPE650Info",&B904SPE650,"LEDMEAN650[48]/D:PEDMEAN650[48]/D:LEDRMS650[48]/D:PEDRMS650[48]/D:TRUEMEAN650[48]/D:TRUERMS650[48]/D:NPE650[48]/D:Charge650[48]/D:GAIN650[48]/D:Rel_TRUEMEAN650[48]/D:Rel_NPE650[48]/D:Rel_Charge650[48]/D:Rel_GAIN650[48]/D:qie650[48]/I:ieta650[48]/I:depth650[48]/I:calib650[48]/D");
    
    i++;
    B904SPE650.LEDMEAN650[i] = LEDMEAN650;
    B904SPE650.PEDMEAN650[i] = PEDMEAN650;
    B904SPE650.LEDRMS650[i] = LEDRMS650;
    B904SPE650.PEDRMS650[i] = PEDRMS650;
    B904SPE650.TRUEMEAN650[i] = TRUEMEAN650;
    B904SPE650.TRUERMS650[i] = TRUERMS650;
    B904SPE650.NPE650[i] = NPE650;
    B904SPE650.Charge650[i] = Charge650;
    B904SPE650.GAIN650[i] = GAIN650;
    B904SPE650.Rel_TRUEMEAN650[i] = Rel_TRUEMEAN650;
    B904SPE650.Rel_NPE650[i] = Rel_NPE650;
    B904SPE650.Rel_Charge650[i] = Rel_Charge650;
    B904SPE650.Rel_GAIN650[i] = Rel_GAIN650;
    B904SPE650.qie650[i] = qie650;
    B904SPE650.ieta650[i] = ieta650;
    B904SPE650.depth650[i] = depth650;
    B904SPE650.calib650[i] = calib650;
  ...
  while(in1>>LEDMEAN700>>PEDMEAN700>>LEDRMS700>>PEDRMS700>>TRUEMEAN700>>TRUERMS700>>NPE700>>Charge700>>GAIN700>>Rel_TRUEMEAN700>>Rel_NPE700>>Rel_Charge700>>Rel_GAIN700>>qie700>>ieta700>>depth700>>calib700) {
    ...
    tree1->Branch("B904SPE700Info",&B904SPE700,"LEDMEAN700[48]/D:PEDMEAN700[48]/D:LEDRMS700[48]/D:PEDRMS700[48]/D:TRUEMEAN700[48]/D:TRUERMS700[48]/D:NPE700[48]/D:Charge700[48]/D:GAIN700[48]/D:Rel_TRUEMEAN700[48]/D:Rel_NPE700[48]/D:Rel_Charge700[48]/D:Rel_GAIN700[48]/D:qie700[48]/I:ieta700[48]/I:depth700[48]/I:calib700[48]/D");

    j++;
    B904SPE700.LEDMEAN700[j] = LEDMEAN700;
    B904SPE700.PEDMEAN700[j] = PEDMEAN700;
    B904SPE700.LEDRMS700[j] = LEDRMS700;
    B904SPE700.PEDRMS700[j] = PEDRMS700;
    B904SPE700.TRUEMEAN700[j] = TRUEMEAN700;
    B904SPE700.TRUERMS700[j] =TRUERMS700;
    B904SPE700.NPE700[j] = NPE700;
    B904SPE700.Charge700[j] = Charge700;
    B904SPE700.GAIN700[j] = GAIN700;
    B904SPE700.Rel_TRUEMEAN700[j] = Rel_TRUEMEAN700;
    B904SPE700.Rel_NPE700[j] = Rel_NPE700;
    B904SPE700.Rel_Charge700[j] = Rel_Charge700;
    B904SPE700.Rel_GAIN700[j] = Rel_GAIN700;
    B904SPE700.qie700[j] = qie700;
    B904SPE700.ieta700[j] = ieta700;
    B904SPE700.depth700[j] = depth700;
    B904SPE700.calib700[j] = calib700;
...
void HFSPEGAINAnalysisforHVandDB() {
  ...
  if(runno == 3012 || runno == 3030 || runno == 3046 || runno == 2995) {
    ...
    runnumber2<<runno<<"_SPEGAINHVDB_map.txt";
    ifstream myin;
...
void HFSPEGAINAnalysisforHV() {
  ...
  runnumber3<<runno<<"_SPEGAINHV.txt";
  ifstream myin2;
...
void HFSPEGAINAnalysis() {

  
  sprintf(rootfile,"/Users/Erkurt/Desktop/!!!THESIS!!!/BURNIN Thesis/B904/HFSPE/SPE_ROOTFILES/Run_%d.root",runno);
  TFile *f = new TFile(rootfile);

  stringstream outfile3;
  outfile3<<runno<<"_HFSPE.root";
  ...
  GAIN_650 = new TH2F("GAIN vs 650V","GAIN vs 650V",48,500,800,48,0,2700000);
  GAIN_700 = new TH2F("GAIN vs 700V","GAIN vs 700V",48,500,800,48,0,2700000);
  GAINHV = new TH2F("GAIN vs HVs","GAIN vs HVs",96,500,800,96,0,2700000);
  ...
  runnumber1<<runno<<"_SPEGAINALL.txt";
  ofstream myfile;
  ...
  runnumber4<<runno<<"_HFSPE650Info.txt";
  ofstream myfile4;
  ...
  runnumber5<<runno<<"_HFSPE700Info.txt";
  ofstream myfile5;
  ...
  ifstream ink;
  ink.open("/Users/Erkurt/Desktop/!!!THESIS!!!/BURNIN Thesis/txt/Calib_constant.txt",ios::in); 
  if(!(ink.good())) { cout<<"There is no Calib_constant.txt"<<endl; }
  
  ifstream input("/Users/Erkurt/Desktop/!!!THESIS!!!/BURNIN Thesis/txt/map.txt",ios::in);
  ...
  if(runno == 3012 || runno == 3030 || runno == 3046 || runno == 2995) {
	...
	for(int hv=0;hv<2;hv++) {
      ...
      voltage1<<runno<<"_SPEGAIN_650V.pdf";
      c1->SaveAs(voltage1.str().c_str());
      voltage1.str("");

      stringstream voltage2;
      voltage2<<runno<<"_SPEGAIN_700V.pdf";
      c2->SaveAs(voltage2.str().c_str());
      voltage2.str("");

      stringstream voltage3;
      voltage3<<runno<<"_SPEGAIN_vs_HVs.pdf";
...
void HFSPEAnalyzer() {
  ...
  ifstream myinput;                                                                                                                                           
  myinput.open("/Users/Erkurt/Desktop/!!!THESIS!!!/BURNIN Thesis/txt/spe_runlist.txt",ios::in); 
  if(!(myinput.good())) {cout<<"There is no avaliable spe_runlist.txt"<<endl;}                                                  

  while(myinput>>runno) {   

 
    HFSPEGAINAnalysis(); 
    HFSPEGAINAnalysisforHV();
    HFSPEGAINAnalysisforHVandDB();
    HFSPEInfo();
