...
void AllHFSPEkdist() {
  ...
  ifstream in;
  in.open("/Users/core/Desktop/!!!THESIS!!!/PMT ANALYSIS /PMTTESTANALYSIS/txt/B904/spe_runlist.txt",ios::in);
  
  while(in>>runno) {

  sprintf(rootfile,"/Users/core/Desktop/!!!THESIS!!!/PMT ANALYSIS /PMTTESTANALYSIS/SORTING/HFSPE/SPENtuples/%d_SPEkdist.root",runno);  
