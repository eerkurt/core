...
void SPEGAINHV(Int_t runno) {
  ...
  sprintf(rootfile,"/Users/core/Desktop/!!!THESIS!!!/PMT ANALYSIS /PMTB904/PMTTESTANALYSIS/SORTING/HFSPE/SPE_ROOTFILES/Run_%d.root",runno);
  TFile *f = new TFile(rootfile);  

  stringstream rootname;
  rootname<<"SPEGAINHV.root";
  TString dir = gSystem->UnixPathName(gInterpreter->GetCurrentMacroName());
  dir.ReplaceAll("./SPEGAINHVFIT.C","SPENtuples/");
...
void SPEGAINHVFIT() {
  ...
  ifstream in1;
  in1.open("/Users/core/Desktop/!!!THESIS!!!/PMT ANALYSIS /PMTB904/PMTTESTANALYSIS/txt/B904/spe_runlist.txt",ios::in);
  ...
  TFile *f3 = new TFile("/Users/core/Desktop/!!!THESIS!!!/PMT ANALYSIS /PMTB904/PMTTESTANALYSIS/SORTING/HFSPE/SPENtuples/SPEGAINHV.root","OPEN");
  ...
  TCanvas *c1 = new TCanvas("c1","SPEGAINHVFIT",600,800);
