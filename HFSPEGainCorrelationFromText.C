      ...
      /*******************************************************************************************
      ****** PROGRAM : HFSPEGainCorrelationFromText.C *******                                  ***
      *******************************************************                                  ***
      ***                                                                                      ***
      ...
      ***                                                                                      ***
      *** This program creates one text file, namely ALLSPEGAINs.txt, and one root file,       ***
      *** namely HFSPEGainCorrelationFromText.root, and makes a correlation with               ***
      *** PMT gain values in terms of different HVs from data within %d_SPEGAINHV.txt          ***
      ***                                                                                      ***
      ***                                                                                      ***
      ********************************************************************************************/
...
void HFSPEGainCorrelationFromText() {
  ...
  ofstream out;
  out.open("/HFSPE/SPENtuples/ALLSPEGAINs.txt",ios::out);

  TFile *f = new TFile("HFSPEGainCorrelationFromText.root","RECREATE");
  ...
  ifstream input;
  input.open("/txt/B904/spe_runlist.txt",ios::in);

  while(input>>runno) {

    sprintf(list,"/HFSPE/SPENtuples/%d_SPEGAINHV.txt",runno);
